...
# Lagrange Attack Adapted from Perceptual Adversarial Robustness Paper
# Added L1 version Perceptual Attack
# Added loss_function option
class LagrangePerceptualAttack_Revised_Lp(nn.Module):
    def __init__(self, 
        ...
        loss_func=None):
        """
            loss_func: the objective function in the maximization problem.
            lpips_distance_norm: L1/L2/Linf version of LPIPS distance measure. 
                                 ** Note: the PAT paper is p-th order sum rather than p-norm.
        """
...
# ==== Copied From: https://github.com/cassidylaidlaw/perceptual-advex
# ==== So that we do not install the entire repo
class FirstOrderStepPerceptualAttack(nn.Module):
    def __init__(self, model, lpips_model,
        ...
        self.loss = MarginLossOrig(kappa=kappa, targeted=targeted)
